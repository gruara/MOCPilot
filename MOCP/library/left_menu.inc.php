  <a href="/MOCP/library/frontpage.php" class="w3-bar-item w3-button">Job Monitor</a>
  ...
  <a href="/MOCP/library/list_log_entries.php" class="w3-bar-item w3-button">List Log</a>
  ...
  <a href="/MOCP/library/add_job_to_schedule.php" class="w3-bar-item w3-button">Add Job to Schedule</a>
  <a href="/MOCP/library/expediate_job.php" class="w3-bar-item w3-button">Expediate Job</a>
  <a href="/MOCP/library/system_information.php" class="w3-bar-item w3-button">System Information</a>
  <a href="/MOCP/library/signon.php" class="w3-bar-item w3-button " >Log out</a>